        ...
        <el-form label-position="left" label-width="140px">
            <el-form-item label="数据起始行">
                <el-row :gutter="10" style="margin-bottom: 8px">
                    <el-col :span="4">
                        <el-input-number size="small" @change="onMetaParserChange" type="number" v-model="dataLine"
                                         :min="1"/>
                    </el-col>
                </el-row>
            </el-form-item>
            ...
            <el-form-item label="服务器列名称">
                <el-row :gutter="10" style="margin-bottom: 8px">
                    <el-col :xs="24" :sm="24" :md="4">
                        <el-input-number size="small" :min="1" @change="onMetaParserChange" type="number"
                                         placeholder="所在行"
                                         v-model="server.name"/>
                    </el-col>
